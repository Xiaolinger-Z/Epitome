...
class Vocab(TorchVocab):
    def __init__(self, counter, max_size=None, min_freq=1):
        ...
        self.eos_index = 2
        self.sos_index = 3
        super().__init__(counter, specials=["<pad>", "<unk>", "<eos>", "<sos>"],
        ...
        for t in texts:
            ...
            for line in tqdm.tqdm(f1):
                ...
                for word in words:
                    counter[word] += 1
            f1.close()
        # print("max label length", max_label_len+2)

        super().__init__(counter, max_size=max_size, min_freq=min_freq)

    def to_seq(self, sentence, seq_len=None, with_eos=True, with_sos=True, with_len=False):
